//
// Created by Thomas Natter on 8/2/16.
//

#ifndef IRUKA_CRC_HPP
#define IRUKA_CRC_HPP
...
namespace rt {
    const int32_t MIN_MAC_LENGTH{14};  // CTS and ACK
    const int32_t MIN_RADIOTAP_LENGTH{15};
    const int32_t MAX_RADIOTAP_LENGTH{50};
}
...
bool crc32(const pcap_pkthdr* header, const u_char* packet) {
    ...
    //return true; // used in case of rpi due to lack of crc field
